...
#ifndef CAR_INTERFACES__SRV__DETAIL__CAR_CONTROL__FUNCTIONS_H_
#define CAR_INTERFACES__SRV__DETAIL__CAR_CONTROL__FUNCTIONS_H_
...
/// Initialize srv/CarControl message.
/**
...
/// Finalize srv/CarControl message.
/**
...
/// Create srv/CarControl message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * car_interfaces__srv__CarControl_Request__init().
...
/// Destroy srv/CarControl message.
/**
 * It calls
 * car_interfaces__srv__CarControl_Request__fini()
...
/// Check for srv/CarControl message equality.
/**
...
/// Initialize array of srv/CarControl messages.
/**
...
/// Finalize array of srv/CarControl messages.
/**
 * It calls
 * car_interfaces__srv__CarControl_Request__fini()
...
/// Create array of srv/CarControl messages.
/**
 * It allocates the memory for the array and calls
 * car_interfaces__srv__CarControl_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/CarControl messages.
/**
 * It calls
 * car_interfaces__srv__CarControl_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/CarControl message array equality.
/**
...
/// Copy an array of srv/CarControl messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * car_interfaces__srv__CarControl_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_car_interfaces
...
/**
 * It calls
 * car_interfaces__srv__CarControl_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_car_interfaces
...
/**
 * It allocates the memory for the array and calls
 * car_interfaces__srv__CarControl_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_car_interfaces
...
/**
 * It calls
 * car_interfaces__srv__CarControl_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // CAR_INTERFACES__SRV__DETAIL__CAR_CONTROL__FUNCTIONS_H_
